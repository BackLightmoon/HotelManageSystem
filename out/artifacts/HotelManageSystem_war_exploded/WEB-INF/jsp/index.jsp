...
<div class="leftnav">
    ...
    <ul>
        <li><a href="/uc/list.do" target="right"><span class="icon-caret-right"></span>客房管理</a></li>
        <li><a href="enterPage.jsp" target="right"><span class="icon-caret-right"></span>入住</a></li>
        <li><a href="checkOutPage.jsp" target="right"><span class="icon-caret-right"></span>退房</a></li>
    </ul>
